...
class PilotsControllerTest < ActionController::TestCase
  ...
  test "should create pilot" do
    assert_difference('Pilot.count') do
      post :create, pilot: { age: @pilot.age, code: @pilot.code, lastname: @pilot.lastname, name: @pilot.name }
    end
  ...
  test "should update pilot" do
    patch :update, id: @pilot, pilot: { age: @pilot.age, code: @pilot.code, lastname: @pilot.lastname, name: @pilot.name }
    assert_redirected_to pilot_path(assigns(:pilot))
  end
